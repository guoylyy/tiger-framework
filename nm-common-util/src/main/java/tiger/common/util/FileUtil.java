 ...
 *
 * @author yiliang.gyl
 * @version v 0.1 Sep 12, 2015 3:02:12 PM yiliang.gyl Exp $
 */
public class FileUtil {
    ...
    public static final String[] SUPPORT_IMAGES = {".png", ".jpeg", ".jpg", ".tiff", ".gif", ".bmp"};
     ...
     * @return
     */
    public static boolean isImageFileFromName(String fileName) {
        for(String key: SUPPORT_IMAGES){
